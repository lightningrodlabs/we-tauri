...
2. Develop your UI code in `we-applet/src/index.ts`, complying with the `NhLauncherApplet` interface defined in [@neighbourhoods/client](https://www.npmjs.com/package/@neighbourhoods/client).
