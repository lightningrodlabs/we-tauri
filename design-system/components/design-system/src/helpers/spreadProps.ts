/**
 * Shamelessly stolen from https://github.com/open-wc/open-wc/blob/master/packages/lit-helpers/src/spread.ts
 * since ther haven't updated their code to support lit ^3.0.0.
 */
