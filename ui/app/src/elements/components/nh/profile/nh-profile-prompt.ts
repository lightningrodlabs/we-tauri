  ...
  static styles: CSSResult[] = [
    ...
    css`
      ...
      #prompt {
        ...
        --sl-color-neutral-0: var(--nh-theme-bg-surface);
        ...
        --sl-input-font-size-medium: var(--nh-font-size-lg);
        --sl-input-label-font-size-medium: var(--nh-font-size-xl);
