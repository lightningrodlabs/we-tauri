    ...
    return html`
      ...
      <mwc-card>
        <div class="column content-pane center-content">
          ...
          <div style="text-align: center; margin-top: 40px; font-size: 1.15em;">
            To join a group, send your public key to the administrator of the
            group you would like to join and ask him/her to invite you.
          </div>
            ...
            <div style="margin-top: 15px;">
              <sl-tooltip placement="right" .content=${"copy"}>
                <div
                  class="pubkey-field"
                  @click=${() => {
                    navigator.clipboard.writeText(this.wesStore.myAgentPubKey);
              ...
              >
                send your public key to your friends if they want to invite you
                to their group
              </div>
            </div>
          </div>
